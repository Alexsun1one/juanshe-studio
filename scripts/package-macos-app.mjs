...
export HARDWRITE_ACTIVATION_REQUIRED="\${HARDWRITE_ACTIVATION_REQUIRED:-1}"
export HARDWRITE_ACTIVATION_VERIFY_URL="\${HARDWRITE_ACTIVATION_VERIFY_URL:-https://your-domain.example/activation-service/verify}"
