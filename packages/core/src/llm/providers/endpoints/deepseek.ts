...
export const DEEPSEEK: HardWriteEndpoint = {
  id: "deepseek",
  label: "DeepSeek",
  group: "china",
  ...
  models: [
    ...
    { id: "deepseek-v4-pro", maxOutput: 393216, contextWindowTokens: 1_000_000, enabled: true, releasedAt: "2026-04-24", fastSibling: "deepseek-v4-flash" },
