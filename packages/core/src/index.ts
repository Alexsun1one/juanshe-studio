...
// Content AST & 平台渲染器（AI 编辑部多平台输出）
export { type ContentDocument, type ContentBlock, type RenderedContent, type Platform as ContentPlatform } from "./content/ast.js";
export { markdownToContentDocument } from "./content/markdown-to-ast.js";
export { renderForPlatform, renderWechat, renderZhihu, renderXiaohongshu, renderX } from "./platforms/index.js";
// Wechat 模板系统(B9)— 5 个内置模板:business/knowledge/story/literary/minimal
export { listWechatTemplates, DEFAULT_WECHAT_TEMPLATE, type WechatTemplateId } from "./platforms/wechat/renderer.js";
// Skill Registry(AI 编辑部技能库)
export { listSkills, loadSkill, SKILL_CATEGORIES, type Skill, type SkillMeta, type SkillCategory } from "./skills/registry.js";
// ContentTypeProfile(一个平台,做很多种内容)
export { CONTENT_TYPE_PROFILES, listContentTypeProfiles, getContentTypeProfile, type ContentTypeProfile, type ProjectType } from "./content-type/profile.js";
export { ROLE_CATALOG, getRole, type RoleMeta } from "./content-type/roles.js";
export { mountSkills, assembleContentType, buildWritingSystemPrompt, type AssembledContentType } from "./content-type/assembly.js";
// 编辑部文章流水线(生成 → 评审 → 修订)
export { buildCriticSystemPrompt, buildReviserSystemPrompt, parseCritiqueReport, critiqueWantsRevision, critiquePasses, DEFAULT_ARTICLE_PASS_SCORE, type CritiqueIssue, type CritiqueReport, type CritiqueSeverity } from "./editorial/article-pipeline.js";
export { buildResearchQueries, buildResearchContext, type ResearchFinding } from "./editorial/research.js";
export { emptyAccountStyle, evolveStyleProfile, buildAccountVoicePrompt, type AccountStyleProfile, type LearnedRule } from "./editorial/account-style.js";
// 知识结构化(把真相文件解析成前端可展示的结构化数据)
export { parseCharacterMatrix, parseRoleFile, classifyRole, type CharacterMatrixEntry, type CharacterRelation, type CharacterKind, type RoleFileSection } from "./knowledge/character-matrix.js";
export { parseEmotionalArcs, groupArcsByCharacter, tensionByChapter, type EmotionalArcPoint, type ChapterTension } from "./knowledge/emotional-arcs.js";
export { parseMarkdownTable, rowToRecord, type ParsedTable } from "./knowledge/markdown-table.js";
export { parsePendingHooks, parseSubplotBoard, hooksByStartChapter, type HookEntry, type SubplotThread } from "./knowledge/story-threads.js";
export { parseVolumeMap, type VolumeInfo } from "./knowledge/volume-map.js";
export { parseChapterSummaries, appearanceCounts, type ChapterSummary } from "./knowledge/chapter-summaries.js";
export { parseStoryFrame, findSection, type ParsedStoryFrame, type StoryFrameSection } from "./knowledge/story-frame.js";
// 工作流健壮性:阶段追踪/时间预算 + 显式 agent 交接契约
...
export {
  ...
  type EditorInChiefMetricSignals,
  type EditorInChiefReaderSignals,
  type EditorInChiefAuditIssue,
  type EditorInChiefTrendPoint,
  type EditorialVerdict,
  type EditorialVerdictKind,
  type EditorialReworkTarget,
...
export { getAllEndpoints, getEndpoint, type HardWriteEndpoint, type HardWriteModel, type EndpointGroup } from "./llm/providers/index.js";
...
export { buildTextDiversityBrief, extractEndingSignature, upsertEndingLedgerFile, type EndingSignature, type EndingLedgerEntry } from "./utils/ending-ledger.js";
...
export { MemoryDB, type Fact, type StoredSummary, type GraphEntity, type GraphRelation, type EntityCard } from "./state/memory-db.js";
...
export { loadLLMEnvLayers, mergeEnvMaps, normalizeHardWriteEnvAliases, studioIgnoredEnv, cliOverlayEnv, legacyEnv, type LLMEnvLayers, type LLMEnvMap } from "./utils/llm-env.js";
