...
const GUIDE_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    no: "07",
    pixel: "capabilities",
    title: "网页版 · 桌面版,各自擅长什么",
    tagline: "同一支编辑部,两种住法 —— 看你想省心,还是想掌控",
    blocks: [
      {
        type: "lead",
        text:
          "卷舍一套代码、两种住法:网页版图省事——打开网址就能写,数据在我们这儿替你存好、随时一键打包带走;桌面版给你全部钥匙——本地模型、一键发各平台、整夜挂机,稿子全落在你自己的硬盘上。不是谁更强,是你这会儿想要省心,还是想要掌控。",
      },
      {
        type: "points",
        items: [
          { k: "网页版擅长", v: "零门槛——开网址即写,不装不配;数据托管在服务器、自动备份、随时一键导出 zip 带走;邮箱账号、积分、激活码、站内动态都在这边。" },
          { k: "桌面版擅长", v: "全部钥匙——连本机 Ollama / 本地模型离线推理;一键发草稿到番茄等平台;无人值守整夜续写、关窗也照跑;工作区落本机硬盘、断网也能打开旧稿。" },
        ],
      },
      {
        type: "points",
        items: [
          { k: "本机模型 / 离线推理", v: "网页 ✗ · 桌面 ✓ —— 网页住在服务器,连不到你电脑的 localhost。" },
          { k: "一键发各平台草稿", v: "网页 ✗(只能复制粘贴)· 桌面 ✓(番茄已通,其余陆续对齐)。" },
          { k: "整夜挂机 / 关窗续写", v: "网页 ◐(2 小时温柔上限、单批 20 章)· 桌面 ✓(不限)。" },
          { k: "数据落本机 / 离线打开", v: "网页 ✗(存服务器,但可一键导出)· 桌面 ✓(稿子就在你硬盘上)。" },
          { k: "随开随写 / 自动备份 / 一键导出", v: "网页 ✓ · 桌面 ✓ —— 两版都顾着你的稿子。" },
        ],
      },
      {
        type: "callout",
        ...
        title: "一句话选版",
        text:
          "想随手就写、不折腾——用网页版;想要本地模型、自动发布、整夜挂机、稿子攥在自己手里——用桌面版。两版数据都能一键导出互通,不锁死。",
      },
    ],
  },
  {
